...
- [ ] 2.5 (P) スキーマ参照候補とクラス定義レジストリの抽出を実装する
...
- [ ] 2.6 (P) 呼び出し式抽出と関数定義レジストリ収集を実装する
...
- [ ] 3.2 (P) 関数単位・ファイル単位の呼び出しグラフ構築を実装する
